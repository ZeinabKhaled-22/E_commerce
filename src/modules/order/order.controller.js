...
import { Cart, Coupon, Order, Prouduct } from "../../../db/index.js"
import { AppError } from "../../utlis/appError.js"
import { discountTypes, paymentMethods } from "../../utlis/constant/enums.js"
...
export const creteOrder = async (req,res,next) => {
    ...
    for (const product of products) {
       // check existence
       const productExist = await Prouduct.findById(product.productId)//{}, null
       if(!productExist){
