...
import { Brand, Prouduct, Subcategroy } from "../../../db/index.js"
...
export const addProduct = async (req,res,next) => {
    ...
    const {secure_url, public_id} = await cloudinary.uploader.upload(req.files.mainImage[0].path, {folder: 'E_commerce/products/main-image'})
